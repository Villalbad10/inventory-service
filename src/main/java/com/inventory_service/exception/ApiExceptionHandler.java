...
public class ApiExceptionHandler {
	...
	@ExceptionHandler({
			com.inventory_service.exception.NotFoundException.class,
			com.inventory_service.exception.ResourceNotFoundException.class
	})
	@ResponseBody
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	@ExceptionHandler({
		com.inventory_service.exception.BadRequestException.class,
	...
	@ExceptionHandler({
			com.inventory_service.exception.ForbiddenException.class
	})
	@ResponseBody
	...
	@ExceptionHandler({
		...
		com.inventory_service.exception.ConflictException.class
	})
	@ResponseBody
	...
	@ExceptionHandler({
			com.inventory_service.exception.UnauthorizedException.class
	})
